...
public class OrderService {
    ...
    public OrderResponseDto placeOrder(OrderRequestDto orderRequestDto) throws ClassNotFoundException, ProductNotFoundException, InvalidCardException, InsufficientQuantityException, CustomerNotFoundException
    {
...
// create order
    ...
    public OrderEntity placeOrder(Cart cart, Card card) throws InsufficientQuantityException
    {
        ...
        orderEntity.setCardUsed(generateMaskedCard(card));
